...
const mensagensDeErro = {
  ...
  senha: {
    ...
    patternMismatch:"A senha deve conter entre 6 a 12 caracteres,deve conter pelo menos uma letra maiscula 1 número e não deve conter símbolos",
  },
  dataNascimento: {
    valueMissing: "O campo de senha não pode esta vazio",
    customError: "Você dever ter maior que 18 anos para se cadastrar",
  },
  cpf: {
...
function validaDataNascimento(input) {
  ...
  if (!maiorQue18(dataRecebida)) {
    mensagem = "Você dever ter maior que 18 anos para se cadastrar"
  }
...
function preencheCamposComCEP(data) {
  ...
  estado.value = data.uf
    ...
    // "fetch" pode se referir a buscar dados ou informações de uma fonte, 
    // como um banco de dados ou API.
    //API é um sistema que você consegue comunicar com ele via http
    //  ele retorna conforme request-requisção.
